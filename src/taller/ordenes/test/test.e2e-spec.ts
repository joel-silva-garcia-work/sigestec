...
export enum INVALID_DTO {
  NULL_TECNICO = 'NULL_TECNICO',
  NO_TECNICO = 'NO_TECNICO',
  EMPTY_TECNICO = 'EMPTY_TECNICO',
  WRONG_TECNICO_TYPE = 'WRONG_TECNICO_TYPE',
  NULL_NOTA_JT = 'NULL_NOTA_JT',
  NO_NOTA_JT = 'NO_NOTA_JT',
  EMPTY_NOTA_JT = 'EMPTY_NOTA_JT',
  WRONG_NOTA_JT_TYPE = 'WRONG_NOTA_JT_TYPE',
  NULL_SOLICITUD = 'NULL_SOLICITUD',
  NO_SOLICITUD = 'NO_SOLICITUD',
  EMPTY_SOLICITUD = 'EMPTY_SOLICITUD',
  WRONG_SOLICITUD_TYPE = 'WRONG_SOLICITUD_TYPE',
...
const resolveRequiredUuids = async () => {
  const resolved: any = {}
  resolved.tecnico = await resolveForeignId('tecnico')
  resolved.solicitud = await resolveForeignId('solicitud')
  return resolved
}
...
describe('API Tests', () => {
  ...
  const generateDto = () => ({
    ...
    solicitud: resolved.solicitud,
    notaJT: randomString(12),
  })
    ...
    switch (invalid) {
      ...
      case InvalidStandardDTO.WRONG_DESCRIPTION_TYPE:
        ...
        break
          ...
          case INVALID_DTO.NULL_TECNICO:
            invalidDto.tecnico = null as any
            break
          case INVALID_DTO.NO_TECNICO:
            delete invalidDto.tecnico
            break
          case INVALID_DTO.EMPTY_TECNICO:
            invalidDto.tecnico = '' as any
            break
          case INVALID_DTO.WRONG_TECNICO_TYPE:
            invalidDto.tecnico = 123 as any
            break
          case INVALID_DTO.NULL_NOTA_JT:
            invalidDto.notaJT = null as any
            break
          case INVALID_DTO.NO_NOTA_JT:
            delete invalidDto.notaJT
            break
          case INVALID_DTO.EMPTY_NOTA_JT:
            invalidDto.notaJT = '' as any
            break
          case INVALID_DTO.WRONG_NOTA_JT_TYPE:
            invalidDto.notaJT = 123 as any
            break
          case INVALID_DTO.NULL_SOLICITUD:
            invalidDto.solicitud = null as any
            break
          case INVALID_DTO.NO_SOLICITUD:
            delete invalidDto.solicitud
            break
          case INVALID_DTO.EMPTY_SOLICITUD:
            invalidDto.solicitud = '' as any
            break
          case INVALID_DTO.WRONG_SOLICITUD_TYPE:
            invalidDto.solicitud = 123 as any
            break
